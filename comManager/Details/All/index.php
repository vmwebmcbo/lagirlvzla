...
<head>
    ...
    <title>Agua de Mayo - Productos</title>
    ...
    <div class="contentWrapper">
            ...
            <nav  class="navbar sticky-top navbar-expand-lg navbar-light bg-white ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto align-self-center">
                        ...
                        <li class="nav-item">
                            <a id="navBarBootstrap" class="nav-link" href="./">Productos</a>
                        </li>
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <?php
                                    foreach ($conn->query($getAllCategories_res) as $categoria) {
                                        echo '<a id="navBarBootstrap" class="dropdown-item" href="./?idc='.$categoria['id_categoria'].'">' . $categoria['nombre'] . '</a>';
                                    }
                                ?>
                            </div>
                        </li>
            ...
            <div class="sort-select-div row pl-5 pr-5 mt-2 mb-2">
              <div class="col-12 pl-0">
                <p style="color:rgb(27, 49, 140); font-weight: 600;">Mostrar por:</p>
              </div>
                          ...
                          <div class="col-lg-3 col-sm-4 col-6 filasTables pl-2 pr-2">
                              <div class="card shadow tarjetaDeCategorias">
                                <img class="card-image" src="../../'.$producto['imagen'].'" style="border-radius:5px;">
                                  ...
                                  <a href="../index.php?idp='.$producto['id_producto'].'" class="btn btn-light">Ver Mas</a>
                              </div>
                          </div>
                        ';
                    }
