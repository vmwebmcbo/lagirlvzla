...
<div class="loader"></div>
    ...
    <div class="success-container">
        ...
        <div class="text-success">
            <h3>Oh no! Your purchase happened to processing</h3>
            <p>You can contact us for more information or repeat the payment procedure</p>
        </div>
        <a href="../../#Contacto">
            <div class="btn-continue">
                Contact Us <i class="fas fa-check"></i>     
            </div>
        </a>
    </div>
