  ...
  if(!empty($_SESSION['cart'])){
    ...
    <table class="table">
      <thead>
        <tr>
          <th scope="col"> </th>
          <th scope="col" id="header-name-us">Name</th>
          <th scope="col" id="header-price-us">Price</th>
          <th scope="col"> </th>
        </tr>
      </thead>
    ';
    ...
    <p id="conditionsTagCart">Extra charges will appear and may modify your total in checkout</p>
    ';
  }else{
    $output = '
          <div class="empty-cart-container">
            ...
            <div class="empty-cart-text">
              <h3 id="empty-cart-title" class="empty-cart-title-us">This Cart is Empty </h3>
              <a  id="empty-cart-title" class="empty-cart-btn-us" href="../Details/All">Shop Now</a>
            </div>
          </div>
          ';
  }
