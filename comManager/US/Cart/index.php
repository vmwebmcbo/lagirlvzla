...
<div class="loader"></div>
    <div class="contentWrapper">
            ...
            <nav  class="navbar sticky-top navbar-expand-lg navbar-light bg-white ">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <?php
                                    foreach ($conn->query($getAllCategories_res) as $categoria) {
                                        echo '<a id="navBarBootstrap" class="dropdown-item" href="../Details/All?idc='.$categoria['id_categoria'].'">' . $categoria['nombre_us'] . '</a>';
                                    }
                                ?>
                            </div>
                        </li>
                ...
                <a id="shoppingCart" class="navbar-brand" href="#">
