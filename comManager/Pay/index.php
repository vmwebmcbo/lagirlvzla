                ...
                <div class="row py-5">
                    ...
                    <div class="col-md-8 order-md-1">
                        ...
                        <form id="form-data" class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <label for="address2">Direccion 2
                            ...
                            <button id="buttonData" class="btn btn-primary btn-lg btn-block" style="color: #fff; background-color: #60297d; border:none" type="button" onclick="submitDataToCheckout()">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                ...
                                <div class="modal-body" id="modalHere">
                                    <form id="payment-form">
                                        <small>Confirma tu informacion y procede con el pago</small>
                                        <ul class="list-group mb-3">
