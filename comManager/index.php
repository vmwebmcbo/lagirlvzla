        ...
        <div id="contentWrapper">
            ...
            <nav  class="navbar shadow fixed-top navbar-expand-lg navbar-light bg-white">
                <a  class="row justify-content-center mt-2" href="#">
                  <img loading="lazy" src="imgProducts/logoRounded.png" id="logoHeader" alt="AGUA DE MAYO">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto align-self-center">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown09" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="flag-icon flag-icon-es"> </span> Español</a>
                            <div class="dropdown-menu" aria-labelledby="dropdown09">
                                <a class="dropdown-item" href="./US/"><span class="flag-icon flag-icon-us"> </span>  English</a>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="row">
                <div class="col-12 banner-webpage-container">
                    <div class="banner-title-container">
                      <?php
                        if( $configPage['titulo_pagina'] != 'none' ){
                          $title_webpage = '
                              <h3 style="color: #'.$configPage['color_title'].';">
                                 '.$configPage['titulo_pagina'].'
                              </h3>
                          ';
                        }else{
                          $title_webpage ="";
                        }
                        if( $configPage['btn_pagina'] != 'none'){
                          $btn_banner = '
                    ...
                    <img id="banner-webpage" loading="lazy" src="<?php echo $configPage['img_pagina']; ?>" alt="">
                </div>
            </div>
                          ...
                          $output .= '
                            <div class="col-sm-3  pl-2 pr-2 col-6">
                                <div class="card shadow tarjetaDeCategorias">
                                      <img width="100%" loading="lazy" src="'.$producto['imagen'].'" style="border-radius:5px;">
                                    <div class="card-body">
                                        <h5 class="cardTitle">'.$producto['nombre']. '</h5>
                                        <p class="card-text cardSubTitle">'.$producto['categoria'].'</p>
                                        <p class="priceTag"><b>$ ' . $producto['precio'] . '</b></p>
                                    </div>
                                    <a href="Details/?idp='.$producto['id_producto'].'" class="btn btn-light">Ver Mas</a>
                                </div>
                            </div>
                          ';
                        }
           ...
           <div class="row mt-5 sobreNosotros-container" style="background-image: url('<?php  echo $configPage['image_aboutus']; ?>')">
             <div class="col-12" id="sobreNosotros">
                  <?php echo $configPage['aboutus_title']; ?>
             </div>
             <div class="col-12" id="sobreNosotrosDescrip">
                  <?php echo $configPage['aboutus_descrip']; ?>
             </div>
      ...
      <div class="container-fluid text-center text-md-left">
        ...
        <div class="row">
          ...
          <div class="col-md-9 mt-md-0 mt-3">
            ...
            <!-- Content -->
            <h5 class="text-uppercase" style="color: #bdbdbd;">Contacto</h5>
            <h6 style="margin: 0; color: #bfbfbf;">Correo Electrónico</h6>
            <p><a href="mailto:duniahz50@gmail.com" style="color: #828282;">duniahz50@gmail.com</a></p>
            <h6 style="margin: 0; color: #bfbfbf;">Teléfono</h6>
          ...
          <div class="col-md-3 mb-md-0 mb-3">
            ...
            <ul class="list-unstyled">
              <li>
                <a style="color: #828282" href="#">Inicio</a>
              </li>
              <li>
                <a style="color: #828282" href="Details/All">Productos</a>
              </li>
              <li>
                  <a  style="font-size: 20pt; color:#343a5f; " class="navbar-brand" href="#">
                          <i class="fab fa-instagram"></i>
