...
$message = '
        ...
        ">
            <h5 style="
                ...
                font-size: 13pt;
            ">Alguien Realizo una compra en tu pagina LA GIRL VENEZUELA</h5>
            <p style="
                width: 100%;
                text-align: center;
                font-family:Arial, Helvetica, sans-serif;
            ">Ingresa al Administrador en la Seccion Pagos. Has Click aqui:<a href="https://lagirlvzla.com/lock_down_admin/"> Administracion</a></p>';
$message .= '
            <div style="
                text-align:center;
                font-family:Arial, Helvetica, sans-serif;
            ">
                ...
                <p>E-Mail: <a href="mailto:info.lagirlvzla@gmail.com">lagirlvzla@gmail.com</a></p>
                <p>
