        ...
        if( isset($_FILES['image']) ){
          ...
          if( $imgType == 'image/jpeg' && $imgSize < 2000000 ){
              ...
              if(move_uploaded_file($_FILES['image']['tmp_name'], $uploadfld.$imgNombre)){
                $result = $manager -> insertCategoria($_POST['nombre'   ],
                                                      'uploads/'.$imgNombre);
                if($result == true)
                  header('location:categorias.php?succ=6');
                else
                  header('location:categorias.php?err=6');
              }else{
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid contentDiv">
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Insertar Categoria</h1>
          <!-- Card Container -->
